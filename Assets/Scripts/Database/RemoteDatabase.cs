...
{
//    //public partial class RemoteDatabase : MonoBehaviour
//    {


//        // singleton for easier access
//        public static RemoteDatabase singleton;
...
//                    // addon system hooks
//                    Utils.InvokeMany(typeof(RemoteDatabase), this, "CharacterLoad_", player);
...
//            // addon system hooks
//            Utils.InvokeMany(typeof(RemoteDatabase), this, "CharacterSave_", player);
